...
List<OrderDetailDTO> orderDetail;
    ...
    public void setOrderDetail(List<OrderDetailDTO> orderDetails) {
...
*/ private String orderId;
    ...
    public OrdersDTO(String orderId, LocalDate orderDate, String customerId, String customerName, BigDecimal orderTotal) {
        this.orderId = orderId;
        this.orderDate = orderDate;
        this.customerId = customerId;
